...
Using the TCGAbiolinks package, we are querying the data directly from the GDC portal. Since the idat files are only availaale from the legacy archive, this needs to be specified. More information on how to auery projects and data types can be found here:
...
# Age prediciton unsing wateRmelons age test agep

To further check the aulity of the data, it is usual to predict the age of the samples based on their methylation rate, and compare this with the actual biological age. This is done using Horvath's coefficients.
